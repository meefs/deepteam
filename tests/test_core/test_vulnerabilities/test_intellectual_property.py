...
class TestIntellectualProperty:
    ...
    def test_intellectual_property_all_types(self):
        ...
        intellectual_property = IntellectualProperty(purpose=TestIntellectualProperty.PURPOSE, types=types)
        assert sorted(
            type.value for type in intellectual_property.types
        ) == sorted(types)

    def test_intellectual_property_all_types_default(self):
        intellectual_property = IntellectualProperty(purpose=TestIntellectualProperty.PURPOSE, )
        assert sorted(
            type.value for type in intellectual_property.types
    ...
    def test_intellectual_property_all_types_invalid(self):
        ...
        with pytest.raises(ValueError):
            IntellectualProperty(purpose=TestIntellectualProperty.PURPOSE, types=types)
