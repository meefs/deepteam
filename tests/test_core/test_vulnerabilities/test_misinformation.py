...
class TestMisinformation:
    ...
    def test_misinformation_all_types(self):
        ...
        misinformation = Misinformation(misinformation_category=TestMisinformation.MISINFORMATION, types=types)
        assert sorted(type.value for type in misinformation.types) == sorted(
            types
        )

    def test_misinformation_all_types_default(self):
        misinformation = Misinformation(misinformation_category=TestMisinformation.MISINFORMATION, )
        assert sorted(type.value for type in misinformation.types) == sorted(
    ...
    def test_misinformation_all_types_invalid(self):
        ...
        with pytest.raises(ValueError):
            Misinformation(misinformation_category=TestMisinformation.MISINFORMATION, types=types)
