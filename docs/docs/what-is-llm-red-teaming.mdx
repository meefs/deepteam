...
## Red teaming on Confident AI

[Confident AI](https://www.confident-ai.com) allows you to connect your production applications to the platform by creating an AI Connection, which allows the platform to communicate with the application via HTTP requests. This allows you to run risk assessments anytime within the UI itself. 

Deployed models are always prone to vulnerabilities and security risks, which is why it is important to ensure that these applications are secure and compliant. Confident AI allows you to schedule recurring risk assessments on your production applications making it a scalable and repeatable workflow.

<BlogImageDisplayer
  src={ASSETS.confidentRedTeamingScheduledFramework}
  alt="Scheduled red teaming automation on Confident AI"
  caption="Scheduling automated risk assessments on Confident AI."
/>
