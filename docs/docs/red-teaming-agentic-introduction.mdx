...
**Agentic red teaming** tests AI agents for vulnerabilities that only emerge when systems operate autonomously, maintain persistent memory, and pursue complex goals. While traditional red teaming asks _"What harmful content can I generate?"_, agentic red teaming asks _"How can I manipulate an autonomous agent to betray its intended purpose?"_
