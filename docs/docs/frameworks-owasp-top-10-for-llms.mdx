...
## Assessing Your Production Application with OWASP

Red teaming your deployed applications is crucial to ensure your LLM applications are secure and compliant. You can run OWASP Top 10 assessments on your production application on Confident AI by directly connecting your application to the platform.

[Confident AI](https://www.confident-ai.com) allows you to directly chat with your deployed application through a postman style connection. This allows you to run OWASP Top 10 assessments against your production application:
