...
sidebar_label: OWASP Top 10 for Agentic Applications
---
...
:::tip
Implement tool orchestration limits, budget constraints, and composition rules. Monitor for unusual tool call patterns that indicate exploitation attempts.
:::
...
- **Protocol Manipulation**: Exploiting weaknesses in agent communication protocols
