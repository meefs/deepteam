...
## Assessing Your Production Application with OWASP ASI

Red teaming your deployed applications is crucial to ensure your LLM applications are secure and compliant. You can run OWASP Top 10 for Agentic Applications assessments on your production application on Confident AI by directly connecting your application to the platform.

[Confident AI](https://www.confident-ai.com) allows you to directly chat with your deployed application through a postman style connection. This allows you to run OWASP ASI assessments against your production application:

<BlogImageDisplayer
  src={ASSETS.confidentSettingsProjectAiConnection}
  alt="AI Connection in Confident AI"
  caption="AI Connection in Confident AI"
/>

Confident AI also provides you with the full risk assessment report after running the assessment.

### Risk assessment reports and PDF export

After a run, Confident AI aggregates results into a **risk assessment** with CVSS-style severity, coverage, and per-test-case detail in the UI. You can also generate a **downloadable risk assessment report (PDF)** to share with security, compliance teams when you need a fixed artifact beyond the live dashboard.
