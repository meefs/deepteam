...
personal_safety = PersonalSafety(safety_category="Your category")
```

There is **ONE** mandatory and **FIVE** optional parameters when creating a `PersonalSafety` vulnerability:

- `safety_category`: The category of the attacks to be generated.
...
You can supply the `PersonalSafety` vulnerability in the `red_team` method as follows:
