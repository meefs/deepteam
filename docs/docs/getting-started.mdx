...
By red teaming using the `RedTeamer` instead of the standalone `red_team()` function, you'll be able to access previously simulated attacks in the `RedTeamer` instance.
