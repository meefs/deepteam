...
## Assessing Your Production Application with NIST AI RMF

Red teaming your deployed applications is crucial to ensure your LLM applications are secure and compliant. You can run NIST AI RMF-aligned assessments on your production application on Confident AI by directly connecting your application to the platform.

[Confident AI](https://www.confident-ai.com) allows you to directly chat with your deployed application through a postman style connection. This allows you to run NIST AI RMF assessments against your production application:
