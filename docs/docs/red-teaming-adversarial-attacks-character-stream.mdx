---
id: red-teaming-adversarial-attacks-character-stream
...
The `CharacterStream` attack method encodes a baseline attack by adding spaces between each character.
