...
**Example (run only resource-development tests):**
...
Would you like me to include a **mapping table** at the end (like NIST's measure summary) showing how each MITRE tactic maps to DeepTeam vulnerabilities and attacks (a compact summary table)? It would make it ready for production docs.
