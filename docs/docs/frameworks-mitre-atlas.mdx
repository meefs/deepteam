...
## Assessing Your Production Application with MITRE ATLAS

Red teaming your deployed applications is crucial to ensure your LLM applications are secure and compliant. You can run MITRE ATLAS-aligned assessments on your production application on Confident AI by directly connecting your application to the platform.

[Confident AI](https://www.confident-ai.com) allows you to directly chat with your deployed application through a postman style connection. This allows you to run MITRE ATLAS assessments against your production application:
