...
title: Vulnerability Introduction
sidebar_label: Introduction
---

`deepteam` offers 50+ read-to-use vulnerabilities for you to quickly get started with red teaming. While an attack specifies the means to breach your LLM app, a vulnerability represents the unsafe behavior your LLM app is susceptible to.
