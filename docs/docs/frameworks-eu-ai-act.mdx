...
The **EU Artificial Intelligence Act** (Regulation (EU) 2024/1689) is the world's first comprehensive legal framework for AI. It uses a **risk-based approach** that classifies AI systems by the harm they may cause to health, safety, and fundamental rights — and imposes proportionate obligations on providers and deployers.
...
The EU AI Act (Regulation (EU) 2024/1689) was adopted in 2024 and is the world's first horizontal law dedicated to AI. It applies to providers and deployers of AI systems that affect people in the EU — regardless of where the provider is based — and takes a **risk-based** approach, assigning obligations according to the harm an AI system can cause.
