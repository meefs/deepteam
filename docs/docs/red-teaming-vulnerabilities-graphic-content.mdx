...
graphic_content = GraphicContent(graphic_category="Your category")
```

There is **ONE** mandatory and **FIVE** optional parameters when creating a `GraphicContent` vulnerability:

- `graphic_category`: The category of the attacks to be generated.
...
You can supply the `GraphicContent` vulnerability in the `red_team` method as follows:
