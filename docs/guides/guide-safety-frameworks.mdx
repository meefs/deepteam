...
[Confident AI](https://www.confident-ai.com) supports running framework-based assessments directly from the platform. Connect your application via an AI Connection, select a framework, and run assessments on demand or on a schedule.
...
The platform generates detailed risk reports with per-category breakdowns, CVSS-style severity scores, and exportable PDFs for compliance documentation.

:::info
Set up [Confident AI](https://app.confident-ai.com) and run your first framework assessment in minutes. **The platform offers a free tier to get started.** *(No credit card required)*
:::
