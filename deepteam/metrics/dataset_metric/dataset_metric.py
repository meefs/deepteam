...
from deepteam.metrics.dataset_metric.schema import *
from deepteam.utils import format_turns


class DatasetMetric(BaseRedTeamingMetric):
    def __init__(
        self,
    ...
    async def _a_evaluate(
        ...
        prompt = HarmTemplate.generate_evaluation_results(
            ...
            harm_category=test_case.vulnerability
        )
    ...
    @property
    def __name__(self):
        return f"Dataset Metric (Red Teaming)"
