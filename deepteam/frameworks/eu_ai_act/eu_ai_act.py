...
class EUAIAct(AISafetyFramework):
    ...
    ALLOWED_TYPES = [
        "art5_subliminal_manipulation",
        "art5_exploitation_of_vulnerabilities",
        "art5_social_scoring",
        "art5_biometric_categorisation",
        "art5_remote_biometric_id_live",
        "art5_remote_biometric_id_post",
        "annex3_biometric_id",
        "annex3_critical_infrastructure",
        "annex3_education",
        "annex3_employment",
        "annex3_essential_services",
        "annex3_law_enforcement",
        "annex3_migration_border",
        "annex3_justice_democracy",
    ]
