...
class MITRE(AISafetyFramework):
    def __init__(
            self,
            categories: List[
                Literal["reconnaissance", "resource_development", "initial_access", "ml_attack_staging", "exfiltration", "impact"]
        ...
        mapping = {
            ...
            "ml_attack_staging": [
                ...
                CustomVulnerability(
                    ...
                    types=["misinformation", "fabrication", "unsupported_claims"],
                ),
                ...
                CustomVulnerability(
                    ...
                    types=["context_poisoning", "prompt_context_overwrite", "poisoned_context"],
                )
            ],
            "exfiltration": [
                PIILeakage(
                ...
                CustomVulnerability(
                    ...
                    types=["data_exfiltration", "encoding_abuse", "obfuscation_leakage"],
                ),
                ...
                CustomVulnerability(
                    ...
                    types=["sensitive_data_disclosure", "unauthorized_access", "privacy_violation"],
                ),
                CustomVulnerability(
                    name="Indirect Prompt Injection",
                    ...
                    types=["data_exfiltration", "context_poisoning", "indirect_injection"],
                ),
                CustomVulnerability(
                    ...
                    types=["prompt_leakage", "instruction_extraction", "system_prompt_disclosure"],
                ),
                IntellectualProperty(
                    types=[
            ...
            "impact": [
                ...
                CustomVulnerability(
                    ...
                    types=["impersonation", "brand_misuse", "identity_fabrication"],
                )
            ]
        }
        return mapping
